...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Hoàng Thiên Long - Trường PTDTBT Tiểu Học Na Khê - ĐT: 086 8512 333</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Hoàng Thiên Long - Trường PTDTBT Tiểu học Na Khê - ĐT: 086 8512 333</div>", unsafe_allow_html=True)
